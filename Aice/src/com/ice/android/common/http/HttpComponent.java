...
public class HttpComponent {
    ...
    private static final ThreadFactory  sThreadFactory = new ThreadFactory() {
        ...
        public Thread newThread(Runnable r) {
        	/**
        	 * mCount.getAndIncrement(): 以原子方式将当前值加 1。
        	 */
    ...
    public HttpComponent() {
        ...
        /**
         * 设置 http请求拦截器  <这地方框架设置的好,重点标记>
         * 在http消息发送到服务器前，该方法被调用
         */
        ...
        /**
         * http响应拦截器  <这地方框架设置的好,重点标记>
         * 在接受服务端响应消息，系统处理前调用,该方法被调用
         */
        ...
        /**
         * 设置 读取超时时, http自动重发请求处理   !!!<这地方框架设置的好,重点标记>
         */
    ...
    /**
     * SSLSocketFactory类介绍：通过它可创建SSLSocket，并可获得相应的加密套件
     * 
